...
void LCD_dispString(unsigned char, unsigned short, unsigned short, unsigned short, unsigned short); // draw string 'c' starting at x,y in color1 with background color2
